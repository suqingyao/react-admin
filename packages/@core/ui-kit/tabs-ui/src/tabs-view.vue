...
import { useForwardPropsEmits } from '@nova-core/composables';
import { ChevronLeft, ChevronRight } from '@nova-core/icons';
import { VbenScrollbar } from '@nova-core/shadcn-ui';
...
const props = withDefaults(defineProps<Props>(), {
  contentClass: 'nova-tabs-content',
  draggable: true,
  styleType: 'chrome',
  wheelable: true,
});
