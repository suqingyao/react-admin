...
import type { VbenLayoutProps } from './nova-layout';
...
} from '@nova-core/composables';
import { IconifyIcon } from '@nova-core/icons';
import { VbenIconButton } from '@nova-core/shadcn-ui';
import { ELEMENT_ID_MAIN_CONTENT } from '@nova-core/shared/constants';
