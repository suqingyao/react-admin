...
import type { MenuRecordRaw } from '@nova/types';

import { computed, onMounted, useSlots, watch } from 'vue';
import { useRoute } from 'vue-router';

import { useRefresh } from '@nova/hooks';
import { $t, i18n } from '@nova/locales';
import {
  preferences,
  updatePreferences,
  usePreferences,
} from '@nova/preferences';
import { useAccessStore } from '@nova/stores';
import { cloneDeep, mapTree } from '@nova/utils';

import { VbenAdminLayout } from '@nova-core/layout-ui';
import { VbenBackTop, VbenLogo } from '@nova-core/shadcn-ui';
