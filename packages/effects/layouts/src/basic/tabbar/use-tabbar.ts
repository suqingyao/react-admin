import { useContentMaximize, useTabs } from '@nova/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '@nova/locales';
import { getTabKey, useAccessStore, useTabbarStore } from '@nova/stores';
import type { TabDefinition } from '@nova/types';
import { filterTree } from '@nova/utils';
import type { IContextMenuItem } from '@nova-core/tabs-ui';
