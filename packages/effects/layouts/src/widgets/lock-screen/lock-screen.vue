...
import { LockKeyhole } from '@nova/icons';
import { $t, useI18n } from '@nova/locales';
import { storeToRefs, useAccessStore } from '@nova/stores';

import { useScrollLock } from '@nova-core/composables';
import { useVbenForm, z } from '@nova-core/form-ui';
import { VbenAvatar, VbenButton } from '@nova-core/shadcn-ui';
