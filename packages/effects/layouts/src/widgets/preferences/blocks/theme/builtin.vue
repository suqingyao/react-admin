...
import type { BuiltinThemePreset } from '@nova/preferences';
import type { BuiltinThemeType } from '@nova/types';

import { computed, ref, watch } from 'vue';

import { UserRoundPen } from '@nova/icons';
import { $t } from '@nova/locales';
import { BUILT_IN_THEME_PRESETS } from '@nova/preferences';
import { convertToHsl, TinyColor } from '@nova/utils';
